...
- **Benchmark đầy đủ:** PIM vs ST / TI / Microchip / NVIDIA-edge — điện năng, độ chính xác phát hiện hồ quang,
  độ trễ, chi phí. `[CẦN số từ product-lead / Pebble Square]`.
- **Kiến trúc Analog-PIM:** tính toán analog trong bộ nhớ flash nhúng; ~4 triệu khớp, ~30 GOPS (chip MINT).
- **Reference design:** cách lắp vào tủ điện/inverter PV; giao tiếp; tiêu thụ điện.
- **Tuân thủ:** ánh xạ với TCVN 7447-7-712:2019 & QCVN 01:2020/BCT.
- **Tham chiếu học thuật:** MDPI Electronics 2024 (arc-fault trên PIM); liên hệ JBNU/KAIST.
